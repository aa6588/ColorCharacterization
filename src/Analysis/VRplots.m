...
xlabel('u')
ylabel('v')
title('[VR] Green Illuminant Achromatic Chromaticity Selections')
end
...
xlabel('u')
ylabel('v')
title('[VR] Blue Illuminant Achromatic Chromaticity Selections')
end
...
xlabel('u')
ylabel('v')
title('[VR] Yellow Illuminant Achromatic Chromaticity Selections')
end
