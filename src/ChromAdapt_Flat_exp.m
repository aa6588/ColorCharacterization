...
for rep = 1:3 %repeat exp 3 times
    ...
    for L = 1:length(L_star)
        [curr_select,curr_lab_select,curr_lab_start] = run_experiment('w',RGB_white_illum,rand_L{L},Flat_RGB_grid,Flat_LAB_grid,t);
...
adapting(RGB_chrom_illum(illum_rand(illums),:),t,120); %adapt to illum for 2 mins
    for rep = 1:3
        ...
        for L = 1:length(L_star)
            ...
            [curr_select,curr_lab_select,curr_lab_start] = run_experiment(curr_illum,curr_illumRGB,rand_L{L},Flat_RGB_grid,Flat_LAB_grid,t);
            tempTable = table(curr_select,curr_lab_select,curr_lab_start,'VariableNames',colnames);
...
%add interjection of white illum trial L55 only
    if illums < 4
        ...
        [curr_select,curr_lab_select,curr_lab_start] = run_experiment('w',RGB_white_illum,'L55',Flat_RGB_grid,Flat_LAB_grid,t);
        tempTable = table(curr_select,curr_lab_select,curr_lab_start,'VariableNames',colnames);
